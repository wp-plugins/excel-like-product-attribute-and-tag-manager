...
if(isset($plem_settings['wpsc_at_fileds'])){
	foreach(explode(",",$plem_settings['wpsc_at_fileds']) as $I => $val){
		if($val)
...
function loadCustomFields(&$plem_settings,&$custom_fileds){
	...
	for($I = 0 ; $I < 8 ; $I++){
		$n = $I + 1;
		if(isset($plem_settings["wpsccf_at_enabled".$n])){
			if($plem_settings["wpsccf_at_enabled".$n]){
				$cfield = new stdClass();
				
				$cfield->type  = get_array_value($plem_settings,"wpsccf_at_type".$n, "");
				if(!$cfield->type)
				  continue;
				  
				$cfield->title = get_array_value($plem_settings,"wpsccf_at_title".$n, "");
				if(!$cfield->title)
				  continue;
			   
				$cfield->source = get_array_value($plem_settings,"wpsccf_at_source".$n, "");
				if(!$cfield->source)
				  continue;  
...
<ul class="menu">
  ...
  <li>
   <a class="cmdBackToJoomla" href="<?php echo "admin.php?page=excellikeattributeandtagmanagerforwoocommerceandwpecommercelight-wpsc"; ?>" > <?php echo __("Back to Wordpress",'excellikeattributeandtagmanagerforwoocommerceandwpecommercelight'); ?> </a>
  </li>
  <?php } ?>
  ...
  <li style="float:right;display:none;" >
   <table>
     <tr><td rowspan="2" ><?php echo __("Input units",'excellikeattributeandtagmanagerforwoocommerceandwpecommercelight');?>:&nbsp;&nbsp;</td><td><?php echo __("Weight",'excellikeattributeandtagmanagerforwoocommerceandwpecommercelight');?></td><td><?php echo __("Height",'excellikeattributeandtagmanagerforwoocommerceandwpecommercelight');?></td><td><?php echo __("Width",'excellikeattributeandtagmanagerforwoocommerceandwpecommercelight');?></td><td><?php echo __("Length",'excellikeattributeandtagmanagerforwoocommerceandwpecommercelight');?></td></tr> 
	 <tr>
...
jQuery(document).ready(function(){
	...
	$('#dg_wpsc').handsontable({
	  ...
	  colHeaders:[
		"ID"
		<?php if(fn_show_filed('name')) echo  ',"'.__("Product Name",'excellikeattributeandtagmanagerforwoocommerceandwpecommercelight').'"';?>
		...
		<?php if(fn_show_filed('taxable')) echo  ',"'. __("Taxable",'excellikeattributeandtagmanagerforwoocommerceandwpecommercelight').'"';?>
		<?php if(fn_show_filed('loc_shipping')) echo  ',"'. __("Local ship.",'excellikeattributeandtagmanagerforwoocommerceandwpecommercelight').'"';?>
		<?php if(fn_show_filed('int_shipping')) echo  ',"'. __("Int. ship.",'excellikeattributeandtagmanagerforwoocommerceandwpecommercelight').'"';?>
		<?php
			foreach($custom_fileds as $cfname => $cfield){ 
